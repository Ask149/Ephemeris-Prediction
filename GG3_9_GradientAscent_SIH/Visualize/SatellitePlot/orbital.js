...
function callCreateOrbit(){
  ...
  for(var i=0;i<axs.length && i<10;i++){
...
/*Orbital.addLaunch = function(name){ 
  ...
  var fire               = $('<div class="add_button burn_toggleable fire"><span class="inactive">fire</span><span class="active">firing <img src="images/burn.svg"/></span></div>');
