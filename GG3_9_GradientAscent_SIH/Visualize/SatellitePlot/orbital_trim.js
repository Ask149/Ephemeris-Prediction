...
const sleep = (milliseconds) => {
  ...
  var getCoordinated = function(a, e, θ, inclination, ω, Ω){
...
function callCreateOrbit(){  
  ...
  for(var i=0; i<plotLength; i++){
    ...
    setTimeout(function(){
      console.log(getCoordinated(axs[i],ecc[i],man[i],inc[i],sog[i],bog[i]));
    }, 1000);
  }
  console.log(axs[0],ecc[0],man[0],inc[0],sog[0],bog[0]);
  console.log(getCoordinated(axs[0],ecc[0],man[0],inc[0],sog[0],bog[0]));
}
